...
extern "C" {
    ...
    void svt_av1_aom_subtract_block_avx2(int rows, int cols, int16_t *diff_ptr, ptrdiff_t diff_stride, const uint8_t *src_ptr, ptrdiff_t src_stride, const uint8_t *pred_ptr, ptrdiff_t pred_stride);
    ...
    int64_t svt_av1_aom_sse_avx2(const uint8_t *a, int a_stride, const uint8_t *b,int b_stride, int width, int height);
    ...
    void svt_av1_aom_lowbd_blend_a64_d16_mask_avx2(uint8_t *dst, uint32_t dst_stride, const CONV_BUF_TYPE *src0, uint32_t src0_stride, const CONV_BUF_TYPE *src1, uint32_t src1_stride, const uint8_t *mask, uint32_t mask_stride, int w, int h, int subw, int subh, ConvolveParams *conv_params);
    ...
    uint64_t svt_av1_aom_sum_squares_i16_sse2(const int16_t *src, uint32_t N);
    #define aom_sum_squares_i16 svt_av1_aom_sum_squares_i16_sse2
...
/* DC_PRED top */
    ...
    static void setup_rtcd_internal(EbAsm asm_type)
    {
        ...
        if (flags & HAS_AVX2) av1_wedge_sse_from_residuals = svt_av1_wedge_sse_from_residuals_avx2;
        aom_subtract_block = aom_subtract_block_c;
        if (flags & HAS_AVX2) aom_subtract_block = svt_av1_aom_subtract_block_avx2;
        aom_sse = aom_sse_c;
        if (flags & HAS_AVX2) aom_sse = svt_av1_aom_sse_avx2;
        av1_build_compound_diffwtd_mask_d16 = av1_build_compound_diffwtd_mask_d16_c;
        if (flags & HAS_AVX2) av1_build_compound_diffwtd_mask_d16 = svt_av1_build_compound_diffwtd_mask_d16_avx2;
        aom_lowbd_blend_a64_d16_mask = aom_lowbd_blend_a64_d16_mask_c;
        if (flags & HAS_AVX2) aom_lowbd_blend_a64_d16_mask = svt_av1_aom_lowbd_blend_a64_d16_mask_avx2;
        av1_wedge_compute_delta_squares = av1_wedge_compute_delta_squares_c;
        if (flags & HAS_AVX2) av1_wedge_compute_delta_squares = svt_av1_wedge_compute_delta_squares_avx2;
        av1_wedge_sign_from_residuals = av1_wedge_sign_from_residuals_c;
        if (flags & HAS_AVX2) av1_wedge_sign_from_residuals = svt_av1_wedge_sign_from_residuals_avx2;
#endif
